...
## 整体架构图
![Image](https://s1.ax1x.com/2020/06/14/NS6rgH.png)
...
![Image](https://s1.ax1x.com/2020/06/14/NS6xGF.png)
...
### 客户端服务端通讯安全
- 通讯层基于Https安全通讯机制
- 业务层客户端使用预埋的RSA公钥加密敏感数据后才发送给服务端
...
## 遗留问题与未来可优化方向
由于时间关系，本项目目前还是有一些地方设计的并不是那么合理，如果有更多时间的话可以针对性的优化一下以下些问题：
- 客户端引入弱密码库，阻止用户用弱账号弱密码组合来注册
- 客户端所有日志信息加密保存下来，提高客户端日志信息安全性
