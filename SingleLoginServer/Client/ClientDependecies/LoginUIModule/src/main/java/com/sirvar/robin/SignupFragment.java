...
public class SignupFragment extends Fragment {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(name.getText().toString())) {
                    Toast.makeText(getActivity().getApplicationContext(), "Please enter phone number!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (TextUtils.isEmpty(confirmPassword.getText().toString())) {
                    Toast.makeText(getActivity().getApplicationContext(), "Please enter password confirm!", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (!password.getText().toString().equals(confirmPassword.getText().toString())) {
                    Toast.makeText(getActivity().getApplicationContext(), "Password and password confirm is different!", Toast.LENGTH_SHORT).show();
                    return;
                }

                ((RobinActivity) getActivity()).onSignup(name.getText().toString(), password.getText().toString(), confirmPassword.getText().toString());
            }
        });
    ...
    private boolean fieldsFilled() {
        return (!(name.getText().toString().isEmpty() || password.getText().toString().isEmpty() || confirmPassword.getText().toString().isEmpty()));
    }
