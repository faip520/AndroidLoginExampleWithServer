...
#define DEFAULT_MYSQL_HOME "/usr/local/Cellar/mysql-client/5.7.23_1"
#define SHAREDIR "/usr/local/Cellar/mysql-client/5.7.23_1/share/mysql"
#define DEFAULT_BASEDIR "/usr/local/Cellar/mysql-client/5.7.23_1"
#define MYSQL_DATADIR "/usr/local/Cellar/mysql-client/5.7.23_1/data"
#define MYSQL_KEYRINGDIR "/usr/local/Cellar/mysql-client/5.7.23_1/keyring"
#define DEFAULT_CHARSET_HOME "/usr/local/Cellar/mysql-client/5.7.23_1"
#define PLUGINDIR "/usr/local/Cellar/mysql-client/5.7.23_1/lib/plugin"
#define DEFAULT_SYSCONFDIR "/usr/local/Cellar/mysql-client/5.7.23_1/etc"
...
#define INSTALL_DOCDIR "/usr/local/mysql/share/doc/mysql-client"
